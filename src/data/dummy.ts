...
export const dummyData: DonationSiteData = {
  ...
  treatmentPlan: {
    ...
    currency: "LKR",
    deadlines: [
      { id: 1, title: "Phase 1", date: "2025-12-23", amount: 700000, description: "Medication procurement and session fees", isCompleted: true },
      { id: 2, title: "Phase 2", date: "2026-01-13", amount: 330000, description: "Medication procurement and session fees", isCompleted: false },
